...
const schema: ModelAttributes<Member, Optional<InferCreationAttributes<Member, { omit: never }>, never>> = {
  id: {
    type: DataTypes.UUID,
    primaryKey: true,
